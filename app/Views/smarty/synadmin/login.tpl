						...
						<div class="card">
							<div class="card-body">
                                                                <div class="mb-4 text-center">
                                                                        <img src="{base_url($company_logo)}" width="180" alt="Imagen" />
                                                                </div>
								<div class="p-4 rounded">
									<div class="text-center">
										<h3 class="">{lang('Login.login_welcome')} {$menu_title}</h3>
										
									</div>
									{$html_errors}
									<div class="login-separater text-center mb-4"> <span>{lang('Login.login_title')}</span>
										<hr/>
									</div>
									<div class="form-body">
										<form action="/ts5/signin" method="POST" enctype="multipart/form-data" class="row g-3">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="user_pass" name="user_pass" value="" placeholder="{lang('Login.login_title_field_pass')}"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-check form-switch">
													<input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked>
													<label class="form-check-label" for="flexSwitchCheckChecked">{lang('Login.login_rememberme')}</label>
												</div>
											</div>
											
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>{lang('Login.button_signin_value')}</button>
												</div>
											</div>
										</form>
									</div>
