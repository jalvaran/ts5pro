...
return [
    ...
    "get_software_ok" => "Software Obtenido correctamente",
    "get_certificate_ok" => "Certificado Obtenido correctamente",
    ...
    "btn_title_pdf" => "Ver PDF",
    "btn_title_reject" => "Rechazar",
    "btn_title_trash"=>"Enviar a la Papelera",
    "btn_title_liquidator"=>"Generar Liquidador",
    "adding"=>"Agregando",
    "added_register"=>"Registro agregado",
    "calculated"=>"Calculando...",
    "calculation_done"=>"Calculo Realizado",
    "getting"=>"Obteniendo",
    "existing_note"=>"Ya existe una nota para este documento",
