 ...
 * -----------------------------------------------------------------------------
 * Modelo para la vista de los adjuntos de las hojas de negocio
 * -----------------------------------------------------------------------------
...
class AttachmentsView extends Model
{

    protected $table = 'view_creditmoto_business_sheet_attachments';
    ...
    public function get_List($business_sheet_id) {
        $result=$this
                ->where('business_sheet_id',$business_sheet_id)                
                ->find();
        return($result);
