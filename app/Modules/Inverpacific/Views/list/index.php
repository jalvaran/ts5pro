                ...
                <div class="email-sidebar-content">
                    <div class="email-navigation" style="overflow:auto">
                        <div class="list-group list-group-flush">
                            ...
                            <a id="link_pre_approved_denied" data-id="4" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-reply me-3 font-20"></i><span><?=lang('fields.pre_approved_denied')?></span></a>
                            <a id="link_approved" data-id="5" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-handshake me-3 font-20"></i><span><?=lang('fields.approved')?></span></a>
                            <a id="link_invoiced" data-id="6" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="bx bx-dollar-circle me-3 font-20"></i><span><?=lang('fields.invoiced')?></span></a>
                            <a id="link_documents_delivered" data-id="7" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-briefcase me-3 font-20"></i><span><?=lang('fields.documents_delivered')?></span></a>
                            <a id="link_signed_documents" data-id="8" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="bx bx-edit me-3 font-20"></i><span><?=lang('fields.signed_documents')?></span></a>
                            <a id="link_official_documents" data-id="9" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-ellipsis-h me-3 font-20"></i><span><?=lang('fields.official_documents')?></span></a>
                            <a id="link_for_delivery" data-id="10" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-truck me-3 font-20"></i><span><?=lang('fields.for_delivery')?></span></a>
                            
                            <a id="link_delivered" data-id="11" href="javascript:;" class="list-group-item  d-flex align-items-center ts_pages_links"><i class="fa fa-tags me-3 font-20"></i><span><?=lang('fields.delivered')?></span></a>
