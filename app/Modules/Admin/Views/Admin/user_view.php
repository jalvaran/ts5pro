<div class="row">
    <div class="col-md-12" style="text-align: center">
        <br>
        <h3><?=lang('admin.user_view_title')?></h3>
        <hr class="my-4">
    </div>
    <div class="col-lg-4">
            ...
            <div class="card-header">
                ...
                <div class="input-group">
                    <select id="role_id"  class="form-select">
                        <option value=""><?=lang("admin.select_roles")?></option>
                    </select>
                    <button id="btn_add_role" class="btn btn-success btn-sm" data-id="<?=$id?>" type="button"><li class="fa fa-plus"></li></button>
                </div>
            </div>
            <div class="card-body" style="overflow: auto;max-height: 300px;">
                <div class="row ">
                    <div id="div_roles_list" class="col" >
