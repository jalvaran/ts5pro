                ...
                foreach ($data_employees as $key => $data_employee){
                    print('<div class="customers-list-item d-flex align-items-center border-top border-bottom p-2">
                                ...
                                <div class="list-inline d-flex customers-contacts ms-auto">	
                                    ...
                                    <a href="javascript:;" title="'.lang("fields.add").'" data-id="'.$data_employee["id"].'" data-general_document_id="'.$general_document_id.'" class="list-inline-item ts_btn_add_employees  cursor-pointer"><i class="fa fa-share rounded text-success"></i></a>
                                </div>
                            </div>');
                }
            }
