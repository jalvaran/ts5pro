 ...
 * -----------------------------------------------------------------------------
 * Modelo para los documentos individuales de nomina
 * -----------------------------------------------------------------------------
...
class IndividualDocuments extends Model
{

    protected $table = 'payroll_individual_documents';
     ...
     * @return type
     */
    public function is_Created($payroll_documents_id,$payroll_employee_id) {
        $row = $this->select("id")
